...
No incluido en esta tanda (fuera de alcance explícito o necesita su propia pasada): edición completa de una publicación ya creada (solo precio es editable hoy), badge de VIP en el deck de swipe (bump tampoco se muestra ahí, se mantuvo consistencia), y el costo de "5✦" mostrado en el botón de desbloqueo VIP es el default hardcodeado en el texto, no el valor de Config en vivo (cosmético, no afecta el cobro real).
