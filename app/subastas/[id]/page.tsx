  ...
  return (
    <div className="max-w-sm mx-auto pb-8">
      <div className="relative w-full aspect-square">
        <Image src={auction.item.imageUrl} alt={auction.item.title} fill sizes="384px" priority className="object-cover" />
        <Link href="/subastas" className="absolute top-4 left-4 bg-white/90 rounded-full p-2 shadow">
